...
function ChatWindow(props) {
    ...
    return (
        // Create main window
        <div className={" chat-window w-[90vw] h-fit overflow-auto p-2.5 rounded-md shadow-md border-stone-300 border-2 bg-stone-100"}>

            {/* Refresh button: */}
            <div className="flex items-center justify-between">
                <div className="text-center flex-1">
                <h1 className="text-2xl font-bold text-blue-900 tracking-widest">Finbuddy 💸</h1>
                <h2 className="text-slate-950 text-sm mb-1">Demystifying Personal Finance For Pakistanis</h2>
                </div>
                <div onClick={() => { restartConvo(id) }}>
                    <button>
            ...
            <div className="message-area border-2 p-2.5 pt-3 border-stone-200 bg-white rounded-md focus-within:outline-none focus-within:border-stone-600">
